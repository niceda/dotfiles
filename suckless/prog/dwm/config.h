...
/* static const char *fonts[]          = { "JetBrainsMono Nerd Font Mono:size=13", "JoyPixels:pixelsize=14:antialias=true:autohint=true"  }; */
/* static const char dmenufont[]       = "JetBrainsMono Nerd Font Mono:size=13"; */
static const char *fonts[]               = { "Source Code Pro Regular:size=24", "JoyPixels:pixelsize=22:antialias=true:autohint=true" };
static const char dmenufont[]       = "Source Code Pro Regular:size=24";
...
static Key keys[] = {
  /* modifier                     key                       function        argument */
	...
	{ MODKEY|ShiftMask,			        XK_w,                     spawn,		       SHCMD("feh --recursive --bg-fill --randomize ~/Pictures/wallpapers/ &") },
